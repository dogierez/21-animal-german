...
let lifetimeScore = parseInt(localStorage.getItem('animalScoreDE')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedAnimalLessonsDE')) || [];
...
const stations = [
    {file:"01_Affen.mp3", title:"1. Aggressive Affen"},
    {file:"02_Ameisen.mp3", title:"2. Ameisen-Opfer"},
    {file:"03_Bienen.mp3", title:"3. Bienen-Demokratie"},
    {file:"04_Schlangen.mp3", title:"4. Kugelfressende Schlangen"},
    {file:"05_Delfine.mp3", title:"5. Chaotische Robben und organisierte Delfine"},
    {file:"06_Oktopus.mp3", title:"6. Cleverer Oktopus"},
    {file:"07_Krabben.mp3", title:"7. Krebs-Mentalität"},
    {file:"08_Hunde.mp3", title:"8. Hunde in der U-Bahn"},
    {file:"09_Empathie.mp3", title:"9. Empathische Maus"},
    {file:"10_Angst.mp3", title:"10. Ängstliche Mäuse"},
    {file:"11_Eichhoernchen.mp3", title:"11. Pflegekind-Eichhörnchen"},
    {file:"12_Hornissen.mp3", title:"12. Gebratene Hornissen"},
    {file:"13_Gibbons.mp3", title:"13. Gierige Gibbons"},
    {file:"14_Trauer.mp3", title:"14. Trauernde Tiere"},
    {file:"15_Hummer.mp3", title:"15. Nachbar-Hummer"},
    {file:"16_Hyaenen.mp3", title:"16. Vetternwirtschaft bei Hyänen"},
    {file:"17_Sklavenameisen.mp3", title:"17. Sklavenhändler-Ameisen"},
    {file:"18_Gorillas.mp3", title:"18. Handelnde Gorillas"},
    {file:"19_Pinguine.mp3", title:"19. Trickreiche Pinguine"},
    {file:"20_Waschbaeren.mp3", title:"20. Urbanisierte Waschbären"},
    {file:"21_Geier.mp3", title:"21. Geier und Teamarbeit"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('animalScoreDE', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) { 
        completedLessons.push(fn); 
        localStorage.setItem('completedAnimalLessonsDE', JSON.stringify(completedLessons)); 
    }
    renderGrid(); 
